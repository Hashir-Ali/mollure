         ...
         <div id="user-info-body" class="accordion-collapse collapse @if($prof->status!='approve') show @endif border mt-2" aria-labelledby="user-info-heading" data-bs-parent="#user-info">
            <div class="accordion-body px-0">
               <div class="bg-white px-2 ps-sm-4 pe-sm-4">
                  <div class="text-end"><span onclick="edit_frm()" class="cursor-pointer"><i class="ri-edit-box-line text-custom-primary icon-textarea "></i>{{$lang_kwords['edit']['dutch']}}</span></div>
                     ...
                     <div class="form-block">
                        ...
                        <div class="mb-4">
                           <label class="fs-5 text-wrap d-block mb-3 form-label"
                              ...
                              >
                           <input type="text" class="form-control frm_inp" placeholder="{{$lang_kwords['insta-link-website-link']['dutch']}}" disabled name="insta_link" id="insta_link" value="{{ $prof->prof_address[0]->insta_link }}" />
                           <input type="text" class="form-control frm_inp mt-2" placeholder="{{$lang_kwords['other-link']['dutch']}} 1" disabled name="facebook_link" id="facebook_link" value="{{ $prof->prof_address[0]->facebook_link }}" />
                           <input type="text" class="form-control frm_inp mt-2" placeholder="{{$lang_kwords['other-link']['dutch']}} 2" disabled name="youtube_link" id="youtube_link" value="{{ $prof->prof_address[0]->youtube_link }}" />
                        </div>
                        <div class="form-row mb-4">
                        ...
                        <div class="d-flex justify-content-center">
                           <button class="btn custom-btn-primary fs-5" type="button" name="form_submit" id="form_submit" style="display:none" value="Update" onclick="form_validate()">{{$lang_kwords['submit']['dutch']}}</button>
                        </div>
                     </div>
                  </form>
               </div>
...
<script type="text/javascript">
  ...
  function des_form_validate2(){
    ...
    $('#des_form_submit2').html('Wait..!').attr('disabled',true);
      ...
      if($('#des_frm2').find('input[name="act"]').val()=='add'){
          $.ajax({
            url:"{{route('nl_admin_desire_add_province')}}",
            type:'post',
  ...
  function show_pro_municipality(){
   ...
   function form_validate1(){
    ...
    $.ajax({
      url:"{{route('nl_admin_fixed_location_update')}}",
      type:'post',
      data:frm,
      contentType: false,
      processData:false,
