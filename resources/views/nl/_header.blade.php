...
<head>
  ...
  <link href="{{ URL::asset('public/css/style.css?2')}}" rel="stylesheet">
    ...
    <div class="container">
      <nav class="navbar navbar-expand-xl ">
        <div class="container-fluid">
          <a class="navbar-brand" href="{{ config('app.url') }}/nl">
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ms-auto my_navbar" @if(Route::currentRouteName()=='nl_login' ) style="visibility:hidden" @endif>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('nl_home') }}#result_expert">@if(isset($menuh['result'])) {{$menuh['result']}} @else Result @endif</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">@if(isset($menuh['mollure'])) {{$menuh['mollure']}} @else Why Mollure @endif</a>
                <ul class="dropdown-menu">
                  <li>
                    <a class="dropdown-item" href="{{route('nl_home')}}#whymollue">@if(isset($menuh['whymollue'])) {{$menuh['whymollue']}} @else Why Mollure @endif</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="{{route('nl_more-mollure')}}">@if(isset($menuh['more-mollure'])) {{$menuh['more-mollure']}} @else More Mollure @endif</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="{{route('nl_about-us')}}">@if(isset($menuh['about-us'])) {{$menuh['about-us']}} @else About Us @endif</a>
                  </li>
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{route('nl_home')}}#guarantee">@if(isset($menuh['guarantee'])) {{$menuh['guarantee']}} @else Guarantee @endif</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{route('nl_home')}}#price">@if(isset($menuh['price'])) {{$menuh['price']}} @else Price @endif</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{route('nl_how-works')}}">@if(isset($menuh['how-it-works'])) {{$menuh['how-it-works']}} @else How it Works? @endif</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{route('nl_contact_us')}}">@if(isset($menuh['contact-us'])) {{$menuh['contact-us']}} @else Contact @endif</a>
              </li>
            ...
            @if(Route::currentRouteName() != 'nl_login' )
            <a href="{{route('nl_login')}}"><button style="font-size: 14px;" class="header_btn my_bg_color_green mt-2 mb-2 mt-xl-0 mb-xl-0">@if(isset($menuh['for_professional'])) {{$menuh['for_professional']}} @else For Professional @endif</button></a>
            @endif
          </div>
        </div>
      </nav>
