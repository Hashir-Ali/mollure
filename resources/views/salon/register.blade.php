...
@section('nav_language')
	...
	<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
		<li class="p-2">
			<a href="https://cynnaenterprises.com/mollure/professional/nl/register">NL</a>
		</li>
	</ul>
@endsection
		...
		<div class="container signupGroup d-flex justify-content-center">
			<div class="signup-card p-4 grid gap-3 justify-content-center align-items-center">
				...
				<form action="" id="frm1" method="post" enctype="multipart/form-data" class="d-grid gap-1 interCardGroupLogin">
					...
					<div class="">
						<label for="legal_name" class="form-label position-relative">{{$lang_kwords['legal-name']['english']}}
						...
						<input type="text" name="legal_name" placeholder="Enter {{$lang_kwords['name-with-a-legal-form']['english']}}" class="form-control" id="legal_name">
					</div>
					<div class="">
						<label for="coc" class="form-label">{{$lang_kwords['coc-number']['english']}}</label>
						<input type="text" placeholder="Enter {{$lang_kwords['coc-number']['english']}}" class="form-control"  name="coc" id="coc" value="{{ old('coc') }}">
					</div>
					<div class="">
						<label for="vat" class="form-label">{{$lang_kwords['vat-number']['english']}}</label>
						<input type="text" placeholder="Enter {{$lang_kwords['vat-number']['english']}}" class="form-control" name="vat" id="vat" value="{{ old('vat') }}">
					</div>
					<div class="">
						<label for="address" class="form-label">{{$lang_kwords['address']['english']}}</label>
						<div class="row px-1">
							<div class="col-6 px-1 mb-2">
								<input type="text" placeholder="{{$lang_kwords['street']['english']}}" class="form-control" name="street" id="street" value="{{ old('street') }}">
							</div>
							<div class="col-6 px-1">
								<input type="text" placeholder="{{$lang_kwords['number']['english']}}" class="form-control" name="number" id="number" value="{{ old('number') }}">
							</div>
							<div class="col-6 px-1 mb-2">
								<input type="text" placeholder="{{$lang_kwords['postal-code']['english']}}" class="form-control" name="postal" id="postal" value="{{ old('postal') }}">
							</div>
							<div class="col-6 px-1">
								<label class="custom-select custom-select-address">
									...
									<span class="err_spn province_err">Please {{$lang_kwords['select']['english']}} {{$lang_kwords['province']['english']}}</span>
								</label>
							</div>
							<div class="col px-1">
								<label class="custom-select custom-select-address">
									<select class="mollure-select-address" name="municipality" id="municipality">
										<option value="" data-i="">{{$lang_kwords['select']['english']}} {{$lang_kwords['municipality']['english']}} </option>
									</select>
									<span class="err_spn municipality_err">Please {{$lang_kwords['select']['english']}} {{$lang_kwords['municipality']['english']}}</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="">
						<label for="contactnumber" class="form-label">{{$lang_kwords['professional-must-provide-examples-of-past-work-that-satisfy-mollures-quality-and-professional-standards']['english']}}</label>
						<input type="text" placeholder="{{$lang_kwords['examples-of-past-work_1']['english']}}" class="form-control" name="insta_link" id="insta_link" value="{{ old('insta_link') }}" >
						<input type="text" placeholder="{{$lang_kwords['examples-of-past-work_2']['english']}}" class="form-control my-2" name="facebook_link" id="facebook_link" value="{{ old('facebook_link') }}">
						<input type="text" placeholder="{{$lang_kwords['examples-of-past-work_3']['english']}}" class="form-control" name="youtube_link" id="youtube_link" value="{{ old('youtube_link') }}" >
...
{{--			                  <span id="file-chosen">Upload Files</span>--}}
