                     ...
                     <div class="form-block mb-5">
                        <div class="form-row mb-4"  style="flex-wrap: wrap;">
                           <div class="label-container">
                              <label class="fs-5 text-nowrap d-block">{{$lang_kwords['legal-name']['dutch']}}</label>
                           </div>
                     ...
                     <div class="form-block">
                           ...
                           <div class="field-container">
                              <select class="form-select bg-light " disabled name="province" id="province">
                                 ...
                                 @foreach($province as $k=>$v)
                                  <option @if( $prof->prof_address[0]->province_id == $v->id) selected @endif value="{{$v->nl_name}}" data-i="{{$v->id}}">{{$v->nl_name}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                           ...
                           <div class="field-container">
                              <select class="form-select bg-light " disabled name="municipality" id="municipality">
                                 ...
                                 @foreach($municipality as $k=>$v)
                                  <option @if( $prof->prof_address[0]->municipality_id == $v->id) selected @endif value="{{$v->nl_name}}" data-i="{{$v->id}}">{{$v->nl_name}}</option>
                                  @endforeach
                              </select>
                           </div>
                        </div>
                           ...
                           <div class="form-row justify-content-between">
                            <div class="row">
                              <div class="col-md-10 col-sm-8 col-12">
                                 <label class="fs-5 text-wrap form-label">{{$lang_kwords['professional-must-provide-documentation-of-registration-in-chamber-of-commerce']['dutch']}}</label>
                              </div>
                        ...
                        <div class="mb-4">
                           <label class="fs-5 text-wrap d-block mb-3 form-label"
                              ...
                              >
                           <input type="text" class="form-control " placeholder="{{$lang_kwords['insta-link-website-link']['dutch']}}" disabled name="insta_link" id="insta_link" value="{{ $prof->prof_address[0]->insta_link }}" />
                           <input type="text" class="form-control  mt-2" placeholder="{{$lang_kwords['other-link']['dutch']}} 1" disabled name="facebook_link" id="facebook_link" value="{{ $prof->prof_address[0]->facebook_link }}" />
                           <input type="text" class="form-control  mt-2" placeholder="{{$lang_kwords['other-link']['dutch']}} 2" disabled name="youtube_link" id="youtube_link" value="{{ $prof->prof_address[0]->youtube_link }}" />
                        </div>
               ...
               <div class="bg-white rounded">
                  ...
                  <div class="fix_loc_sec">
                    <div class="block-heading text-white px-3 py-2 rounded fs-5 mb-3 mx-0 me-sm-2 ms-sm-2">
                     ...
                     <form action="{{route('nl_fixed_location_update')}}" id="frm1" class="fix_loc_form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ Session::token() }}" />
                        <div class="row px-0 pe-sm-4 ps-sm-4  sub-temp-fixed-loc mb-4">
                           ...
                           <div class="col-12 col-lg-9">
                              <div class="form-icon icon-right-align mb-2">
                                 <input class="form-control form-control-icon frm_inp1" type="text" placeholder="{{$lang_kwords['professional-name-salon-name']['dutch']}}"  disabled name="fixed_name" id="fixed_name" value="{{$prof->fixed_name_nl}}"/>
                              ...
                              <div class="form-icon icon-right-align">
                                 <textarea class="form-control form-control-icon frm_inp1" type="text" placeholder="Bio" disabled name="fixed_bio" id="fixed_bio">{{$prof->fixed_bio_nl}}</textarea>
                                 <!-- <i class="ri-edit-box-line text-custom-primary icon-textarea fs-5"></i> -->
                              </div>
                           </div>
                        </div>
                        <div class="d-flex justify-content-center mb-5">
                           <button class="btn custom-btn-primary fs-5" type="button" name="form_submit1" id="form_submit1" style="display:none" value="{{$lang_kwords['save']['dutch']}}" onclick="form_validate1()">{{$lang_kwords['save']['dutch']}}</button>
                        </div>
                     </form>
                  ...
                  <div class="dis_loc_sec" style="display:none">
                    <div class="block-heading text-white px-3 py-2 rounded fs-5 mb-3 mx-2 des_title2">
                     ...
                     <form action="{{route('nl_fixed_location_update')}}" id="des_frm1" class="des_loc_form" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ Session::token() }}" />
                        <div class="row px-4 sub-temp-fixed-loc mb-4">
                           ...
                           <div class="col-12 col-lg-9">
                              <div class="form-icon icon-right-align mb-2">
                                 <input class="form-control form-control-icon des_frm_inp1" type="text" placeholder="{{$lang_kwords['professional-name-salon-name']['dutch']}}"  disabled name="desire_name" id="desire_name" value="{{$prof->desire_name_nl}}"/>
                                 <i class="ri-edit-box-line text-custom-primary fs-5 cursor-pointer" onclick="edit_des_bio_frm()"></i>
                              </div>
                              <div class="form-icon icon-right-align">
                                 <textarea class="form-control form-control-icon des_frm_inp1" type="text" placeholder="Bio" disabled name="desire_bio" id="desire_bio">{{$prof->desire_bio_nl}}</textarea>
                                 <!-- <i class="ri-edit-box-line text-custom-primary icon-textarea fs-5"></i> -->
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="px-4 py-2 mb-4 des_loc_type_sec" style="background-color: #f5f3f4;">
                        <div class="px-5 py-4 rounded " style="background-color: #f5f3f4;">
                           <div class="d-flex flex-wrap">
                              ...
                              <div class="form-check d-flex align-items-center mx-auto">
                                 <button type="button" id="des_add_prov_btn" style="display:none" class="btn cs_btn gradient-btn" onclick="add_province_act()">+ Add {{$lang_kwords['province']['dutch']}}</button>
                              </div>
                           </div>
                        </div>
                              ...
                              <form action="" id="des_frm2" class="" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-4 text-end">
                                      <span class="cursor-pointer add_mun_spn" style="display:none" onclick="show_pro_municipality()">+ Add {{$lang_kwords['municipality']['dutch']}}</span>
                                    </div>
                                  </div>
                              </form>
                          </div>
                     ...
                     <div class="col-12 col-md-6 col-lg-5">
                      <label class="h5 mb-3 pb-3 border-bottom w-100 text-center">{{$lang_kwords['price']['dutch']}}</label>
                        ...
                        <div class="form-check d-flex align-items-center me-5 mb-2">
                           ...
                           {{$lang_kwords['discount']['dutch']}} <small><i>({{$lang_kwords['optional']['dutch']}})</i></small>
                           </label>
                        </div>
                    ...
                    <div class="px-2 text-end mb-2">
                     ...
                     <div class="row px-2 ps-sm-4 pe-sm-4 sub-temp-fixed-loc mb-4">
                        ...
                        <div class="col-12 col-md-6 col-lg-9 mb-md-2 mb-2">
                           <div class="form-icon icon-right-align mb-2">
                              <input class="form-control form-control-icon" id="team_member_name" name="team_member_name" type="text" placeholder="{{$lang_kwords['professional-name-salon-name']['dutch']}}" />
...
<!--Visual End-->
                  ...
                  <div class="container general-note-container mb-5 text-center">
                    <input type="button" value="{{$lang_kwords['copy-to-desire-location']['dutch']}}" class="btn btn-primary rounded-pill" id="copy_btn" onclick="copy_desire()">
                  </div>
...
<div class="container mb-5">
  <div class="row" id="fix_info_reg_sec">
    <div class="col-md-12 text-center">
      @if($prof->fixed_info_nl=='2' || $prof->fixed_info_nl=='')
  ...
  <div class="row" id="des_info_reg_sec" style="display:none">
    <div class="col-md-12 text-center">
      @if($prof->desire_info_nl=='2'  || $prof->desire_info_nl=='')
   ...
   <div class="modal-content">
     ...
     <div class="modal-body text-center">
       ...
       <div class="mt-5 d-flex" style="    justify-content: space-around;">
        ...
        <div>
          <a href="{{route('dashboard')}}?t=f" style="width: 100px;" class="btn btn-warning">No</a>
        </div>
       </div>
     </div>
   </div>
...
<script type="text/javascript">
  ...
  function des_form_validate2(){
    ...
    if($('#des_frm2').find('input[name="act"]').val()=='add'){
      ...
      $.ajax({
        url:"{{route('nl_desire_add_province')}}",
        type:'post',
...
*/
          ...
          if(r.msg=='Y'){
            ...
            $.each(service,function(k,v){
              str+='<div class="category-table-row d-flex bg-light-primary mt-2" id="serv_sec_m_'+v.id+'">';
                ...
                if(v.discount=='1'){
                 str+='<br><b class="fs-6">Discount: </b>';   
      ...
      $.ajax({
        ...
        success:function(r){
          if(r.status=='SUCCESS'){
            ...
            if(service.length>0){
               var str='<label class="me-3"><input type="checkbox" name="" class="temp_serv_all" value="1" onclick="sel_all_temp_serv()"> All</label>';
               $.each(service, function(k,v){
                  var chk='';
                  var vi = ''+v.i+'';
                  ...
                  str+='<label class="me-3"><input type="checkbox" name="team_service[]" class="temp_serv" value="'+v.i+'" '+chk+'> '+v.service_name+'</label>';
               });
            ...
            var str1='<label class="me-3"><input type="checkbox" name="" class="temp_ct_all" value="1" onclick="sel_all_temp_ct()"> All</label>';
            $.each(category, function(k,v){
               ...
               str1+='<label class="me-3"><input type="checkbox" class="temp_ct" name="team_cate[]" value="'+v.i+'" '+chk+'> '+v.cat+'</label>';
            });
      ...
      success: function(r)
      {
        ...
        var cate_str='<div class=" " style="justify-content: space-between;display: flex;flex-wrap:wrap">';
          $.each(categories,function(k,v){
            ...
            cate_str+='<div class="cate_sec  mb-3 cate_sec_'+v.id+'" onclick="show_salon_cate_detail(\'f\', \''+v.id+'\' ,\''+v.nl_name+'\',\'0\')" data-cate="'+v.name+'"><div class="cate_cards shadow p-2 sub-temp-fixed-loc-card '+cls+'" id="cate_card_'+v.id+'">';
              // console.log(v.image);
              if(v.image!='' && v.image!==null)
                cate_str+='<img src="{{asset("public/imgs/category/")}}/'+v.image+'" style="width:auto;max-width:100%;">';
              else
   ...
   function form_validate1(){
    ...
    $.ajax({
      url:"{{route('nl_fixed_location_update')}}",
      type:'post',
      data:frm,
      contentType: false,
      processData:false,
