...
@section('nav_language')
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
        <li class="p-2">
            <a href="https://cynnaenterprises.com/mollure/individual/register">EN</a>
        </li>
    </ul>
@endsection
...
{{--                        <label for="firstname" class="form-label">{{$lang_kwords['contact-person']['dutch']}}</label>--}}
                        <div class="row px-1">
                            <div class="col px-1">
                                <label for="contact_person_first_name" class="form-label">{{$lang_kwords['first-name']['dutch']}}</label>
                            ...
                            <div class="col px-1">
                                <label for="contact_person_last_name" class="form-label">{{$lang_kwords['last-name']['dutch']}}</label>
                    ...
                    <div class="">
                        ...
                        <input type="text" placeholder="Birth date DD/MM/YYYY" class="form-control"  name="name_for_rating" id="name_for_rating" value="{{ old('contact_number') }}">
                    </div>
                    <div class="">
                        <div>
