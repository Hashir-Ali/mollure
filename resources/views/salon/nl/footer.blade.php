...
if(!isset($menuf)){
  $menuf = Controller::get_page_menu('footer','nl');
}
        ...
        <footer>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4 offset-md-2">
                        <div class="text-center">
                            <!-- <i class="ri-earth-fill me-2"></i> www.mollure.com -->
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <div class="text-center">
                ...
                <div class="row">
                    <div class="col-sm-6 offset-sm-3">
                        <div class="mail_box">
                            <input class="form-control form-control-icon py-3 ps-4 border-0" type="text" placeholder="{{$ftlng['enter-your-email']['dutch']}}" />
                            <button>
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <ul class="text-center ">
                          <li class="d-sm-inline-block"><a class="text-body" href="{{route('nl_term_condition')}}">@if(isset($menuf['terms-conditions'])) {{$menuf['terms-conditions']}} @else Terms & Conditions @endif</a></li>
