...
@section('nav_language')
	...
	<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
		<li class="p-2">
			<a href="https://cynnaenterprises.com/mollure/professional/register">EN</a>
		</li>
	</ul>
@endsection
		...
		<div class="container signupGroup d-flex justify-content-center">
			<div class="signup-card p-4 grid gap-3 justify-content-center align-items-center">
				...
				<form action="" id="frm1" method="post" enctype="multipart/form-data" class="d-grid gap-1 interCardGroupLogin">
					...
					<!-- Prof chamber -->
					<div class="">
						<label for="uploadfile" class="form-label"> {{$lang_kwords['professional-must-provide-documentation-of-registration-in-chamber-of-commerce']['dutch']}}</label>
						...
						<span class="err_spn registration_doc_err">{{$lang_kwords['please-upload-doc']['dutch']}}</span>
					</div>
					...
					<div class="">
						<label for="contactnumber" class="form-label">{{$lang_kwords['professional-must-provide-examples-of-past-work-that-satisfy-mollures-quality-and-professional-standards']['dutch']}}</label>
						<input type="text" placeholder="{{$lang_kwords['examples-of-past-work_1']['dutch']}}" class="form-control" name="insta_link" id="insta_link" value="{{ old('insta_link') }}" >
						<input type="text" placeholder="{{$lang_kwords['examples-of-past-work_2']['dutch']}}" class="form-control my-2" name="facebook_link" id="facebook_link" value="{{ old('facebook_link') }}">
						<input type="text" placeholder="{{$lang_kwords['examples-of-past-work_3']['dutch']}}" class="form-control" name="youtube_link" id="youtube_link" value="{{ old('youtube_link') }}" >
						<span class="err_spn insta_link_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span>
					</div>
					<div class="">
	...
	<script type="text/javascript">
		...
		function form_validate(){
			...
			if($('.registration_doc_inp').length<=0){
				...
				$('html, body').animate({
					scrollTop: $('#file-chosen').offset().top-100
				}, 500);
				return false;
			}
			// console.log('888');
...
{{--   <div class="block-heading text-white px-3 py-2 rounded fs-5 mb-3">{{$lang_kwords['user_info']['dutch']}}</div>--}}
...
{{--	         <span class="form-number-label me-2">{{$lang_kwords['basic-info']['dutch']}}</span>--}}
{{--	         <div class="form-header-line flex-grow-1"></div> -->--}}
{{--	      </div>--}}
{{--	      <div class="form-block mb-5">--}}
{{--	         <div class="form-row mb-4" style="flex-wrap: wrap;">--}}
{{--	            <div class="label-container">--}}
{{--	               <label class="fs-5 text-nowrap d-block">{{$lang_kwords['legal-name']['dutch']}} <i class="ri-information-fill tooltip_spn1 tooltip_spn_1"></i><div class="tooltip"><span class="tooltiptext"><small>{{$lang_kwords['name-with-a-legal-form']['dutch']}}</small></div></span></label>--}}
{{--	            </div>--}}
{{--	            <div class="field-container"><input type="text" class="form-control" name="legal_name" id="legal_name" value="{{ old('legal_name') }}"/>--}}
{{--	            	<span class="err_spn legal_name_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span>--}}
{{--	            </div>--}}
{{--	            <!-- <small>{{$lang_kwords['name-with-a-legal-form']['dutch']}}</small> -->--}}
{{--	         </div>--}}
...
{{--	            	<span class="err_spn coc_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span>--}}
{{--	            </div>--}}
{{--	         </div>--}}
{{--	         <div class="form-row mb-4">--}}
{{--	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['vat-number']['dutch']}}</label></div>--}}
{{--	            <div class="field-container"><input type="text" class="form-control" name="vat" id="vat" value="{{ old('vat') }}"/><span class="err_spn vat_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span></div>--}}
{{--	         </div>--}}
{{--	      </div>--}}
{{--	      <div class="d-flex mb-4">--}}
...
{{--	            <div class="field-container"><input type="text" class="form-control" name="street" id="street" value="{{ old('street') }}"/><span class="err_spn street_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span></div>--}}
{{--	         </div>--}}
{{--	         <div class="form-row mb-4">--}}
{{--	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['number']['dutch']}}</label></div>--}}
{{--	            <div class="field-container"><input type="text" class="form-control" name="number" id="number" value="{{ old('number') }}"/><span class="err_spn number_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span></div>--}}
{{--	         </div>--}}
{{--	         <div class="form-row mb-4">--}}
{{--	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['postal-code']['dutch']}}</label></div>--}}
{{--	            <div class="field-container"><input type="text" class="form-control" name="postal" id="postal" value="{{ old('postal') }}"/><span class="err_spn postal_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span></div>--}}
{{--	         </div>--}}
{{--	         --}}
{{--	         <div class="form-row mb-4">--}}
...
{{--	                  <option>{{$lang_kwords['select']['dutch']}}</option>--}}
{{--	                  @foreach($province as $k=>$v)--}}
{{--	                  <option value="{{$v->nl_name}}" data-i="{{$v->id}}">{{$v->nl_name}}</option>--}}
{{--	                  @endforeach--}}
{{--	               </select>--}}
...
{{--	         </div>--}}
{{--	         <div class="form-row mb-4">--}}
{{--	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['municipality']['dutch']}} <span class="rotate spinner" style="display:none" id="prov_spn"></span></label></div>--}}
{{--	            <div class="field-container">--}}
...
{{--	                  <input type="text" placeholder="{{$lang_kwords['first-name']['dutch']}}" class="form-control" name="contact_person_first_name" id="contact_person_first_name" value="{{ old('contact_person_first_name') }}"/>--}}
{{--	                  <span class="err_spn contact_person_first_name_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span>--}}
{{--	               </div>--}}
{{--	               <div class="flex-fill">--}}
{{--	                  <input type="text" placeholder="{{$lang_kwords['last-name']['dutch']}}" class="form-control" name="contact_person_last_name" id="contact_person_last_name" value="{{ old('contact_person_last_name') }}"/>--}}
{{--	               </div>--}}
...
{{--	            <div class="field-container"><input type="text" class="form-control" name="contact_number" id="contact_number" value="{{ old('contact_number') }}"/><span class="err_spn contact_number_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span></div>--}}
{{--	         </div>--}}
{{--	         <div class="mb-4">--}}
{{--	            <label class="fs-5 text-wrap d-block mb-3 form-label"--}}
{{--	               >{{$lang_kwords['professional-must-provide-examples-of-past-work-that-satisfy-mollures-quality-and-professional-standards']['dutch']}}--}}
{{--	           </label>--}}
{{--	            <input type="text" class="form-control" placeholder="{{$lang_kwords['examples-of-past-work_1']['dutch']}}" name="insta_link" id="insta_link" value="{{ old('insta_link') }}" />--}}
{{--	            <input type="text" class="form-control frm_inp mt-2" placeholder="{{$lang_kwords['examples-of-past-work_2']['dutch']}}" name="facebook_link" id="facebook_link" value="{{ old('facebook_link') }}" />--}}
{{--                <input type="text" class="form-control frm_inp mt-2" placeholder="{{$lang_kwords['examples-of-past-work_3']['dutch']}}" name="youtube_link" id="youtube_link" value="{{ old('youtube_link') }}" />--}}
{{--	            <span class="err_spn insta_link_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span>--}}
{{--	         </div>--}}
{{--	         <div class="form-row mb-4">--}}
{{--	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['email']['dutch']}}</label></div>--}}
...
{{--	            <span class="err_spn password_err">{{$lang_kwords['please-fill-detail']['dutch']}}</span></div>--}}
{{--	         </div>--}}
{{--	         <div class="form-row mb-4">--}}
{{--	            <div class="label-container"><label class="fs-5 text-nowrap d-block">{{$lang_kwords['repeat-password']['dutch']}}</label></div>--}}
{{--	            <div class="field-container"><input type="password" class="form-control" name="conf_password" id="conf_password"/><span class="err_spn conf_password_err">{{$lang_kwords['password-dont-match']['dutch']}}</span></div>--}}
{{--	         </div>--}}
{{--	         <div class="form-row mb-4">--}}
...
{{--	            <label class="form-check-label fs-5 form-label" for="flexCheckDefault"> {{$lang_kwords['accept-our']['dutch']}} <a href="{{route('term_condition')}}" target="_blank" style="text-decoration:none">{{$lang_kwords['terms-and-conditions']['dutch']}}</a> </label>--}}
{{--	         </div>--}}
{{--	         <div class="d-flex justify-content-center">--}}
{{--	            <button class="btn custom-btn-primary fs-5" type="button" name="form_submit" id="form_submit" value="Submit" onclick="form_validate()">{{$lang_kwords['submit']['dutch']}}</button>--}}
{{--	         </div>--}}
{{--	      </div>--}}
{{--	  	</form>--}}
{{--   </div>--}}
...
{{--        	<h3 class="text-custom-primary my-4">Bedankt <br> voor registratie bij Mollure!</h3>--}}
{{--        	<p class="mt-4" style="font-size:24px;">We nemen zo snel mogelijk contact met u op.</p>--}}
{{--        	<p class="mt-4" style="font-size:20px;"><a href="{{config('app.url')}}">Terug naar huis</a></p> -->--}}
{{--        </div>--}}
{{--      </div>--}}
{{--      <!-- <div class="modal-footer">--}}
{{--        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>--}}
